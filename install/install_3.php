				...
				<div class="log_box">
					...
					<div class="gray_box">
						<div class="box">
							...
							<strong>安装选择</strong>
							<label for=""><input class="radio" type="radio" name='install_type' value='all' <?php if(!file_exists(ROOT_PATH.'./install/iwebshop_test.sql')){?> disabled=disabled <?php }?> />安装带测试数据版本</label><br />
							<label for=""><input class="radio" type="radio" name='install_type' checked=checked value='simple' />安装绿色纯净版本</label>
